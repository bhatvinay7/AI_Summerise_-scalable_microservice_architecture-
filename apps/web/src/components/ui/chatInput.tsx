...
export default function ChatInput({
  ...
  return (
    <div className=" w-3/4 md:w-4/5 lg:w-1/2 h-auto relative border-white/20 min-h-20 sm:min-h-24 flex flex-col px-4 py-5 space-y-3 gap-y-6 bg-[#2f2f2d] border placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20 rounded-3xl  ">
  ...
  title="Attach file"
>
  <Paperclip className="w-5 h-5 sm:w-6 sm:h-6 text-white/80" />
</button>
...
>
  <Send className="w-5 h-5 sm:w-6 sm:h-6 text-white/80" />
</button>
          ...
          {/* <button
            type="button"
            onClick={handleSend}
            className=" inline-flex items-center justify-center relative w-[50px] p-4 ml-2  right-2 top-1  px-2 h-10 rounded-xl bg-[#2f2f2a] hover:bg-white/15 border border-white/10 transition"
          >
